...
model = torch.hub.load('C:/Users/Kwonbokyung/PycharmProjects/SeochoFlower-main', 'custom',
                       path='C:/Users/Kwonbokyung/PycharmProjects/SeochoFlower-main/ml/best.pt', source='local')  # local repo
...
def analyze():
    if request.method == "POST":
        ...
        with open("C:/Users/Kwonbokyung/PycharmProjects/SeochoFlower-main/static/img/" + imageFile, 'rb') as f:
            fileRead = f.read()

        img = Image.open(io.BytesIO(fileRead))
        # 이미지파일 임시 저장
        savePath = "C:/Users/Kwonbokyung/PycharmProjects/SeochoFlower-main/datasets/images/train/"  # 매번 비워지는 임시 저장소
        savePath2 = "C:/Users/Kwonbokyung/PycharmProjects/SeochoFlower-main/datasets/images/val/"  # 누적 저장
